                ...
                <div class="row">
                  <div class="col-12">
                    <div class="form-group row">
                      ...
                      <div class="col-md-8">
                        <input type="text" placeholder="Id" class="form-control" name="rm_id">
                      </div>
                    </div>
                  </div>
                  <div class="col-12">
                      ...
                      <div class="col-md-8">
                        <select multiple class="form-control" name="obat_id[]" size="7" required>
                          <?php foreach ($obats as $obat) : ?>
                            <option value="<?= $obat['obat_id']; ?>"><?= $obat['nama_obat']; ?></option>
                          <?php endforeach; ?>
                        </select>
                      </div>
                    </div>
                      ...
                      <div class="col-md-8">
                        <select class="select2 form-control" name="ruang_id" required>
                          <?php foreach ($ruangs as $ruang) : ?>
                            <option value="<?= $ruang['ruang_id']; ?>"><?= $ruang['nama_ruang']; ?></option>
                          <?php endforeach; ?>
                        </select>
                      </div>
                    </div>
