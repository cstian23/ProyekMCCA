                ...
                <tbody>
                  <?php foreach ($ruangs as $ruang) : ?>
                    <tr>
                      ...
                      <td>
                        <a href="?page=edit-ruang&ruang_id=<?= $ruang['ruang_id']; ?>"><i class="m-1 feather icon-edit-2"></i></a>
                        <a href="?page=hapus-ruang&ruang_id=<?= $ruang['ruang_id']; ?>" class="btn-hapus"><i class="feather icon-trash"></i></a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
